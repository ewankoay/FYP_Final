...
REAL interpolation(PARA_DATA *para, REAL *d0, REAL x_1, REAL y_1, REAL z_1,
  ...
  case BILINEAR:
    return interpolation_bilinear(
        x_1, y_1, z_1, d0[IX(p, q, r)], d0[IX(p, q + 1, r)],
        d0[IX(p + 1, q, r)], d0[IX(p + 1, q + 1, r)], d0[IX(p, q, r + 1)],
        d0[IX(p, q + 1, r + 1)], d0[IX(p + 1, q, r + 1)],
        d0[IX(p + 1, q + 1, r + 1)]);
    break;
  default:
    sprintf(msg,
            "interpolation(): the required interpolation method %d is not "
            "available.",
...
///\return Interpolated value
///////////////////////////////////////////////////////////////////////////////
REAL interpolation_bilinear(REAL x_1, REAL y_1, REAL z_1, REAL d000, REAL d010,
                            REAL d100, REAL d110, REAL d001, REAL d011,
                            REAL d101, REAL d111) {
  REAL x_0, y_0, z_0;
  REAL tmp0, tmp1;
